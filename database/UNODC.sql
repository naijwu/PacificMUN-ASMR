...
--
-- Host: localhost:3306
-- Generation Time: Jan 15, 2020 at 02:14 AM
...
--
-- Table structure for table `UNODC`
--
...
--
-- Dumping data for table `UNODC`
--

INSERT INTO `UNODC` (`delegation`, `powerranking`, `reservedby`, `confirmedby`) VALUES
('Afghanistan', 0, '', ''),
('Australia', 0, '', ''),
('Bangladesh', 0, '', ''),
('Belgium', 0, '', ''),
